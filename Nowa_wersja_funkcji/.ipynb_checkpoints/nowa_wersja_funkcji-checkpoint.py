...
def cutting_scrap(path_to_file_before_MAFFT, path_to_file_after_MAFFT, acceptable_gap_length):
    ...
    print(f'{((total_files - len(broken_files)) / total_files) }% of files end up succesfully. {len(broken_files)} had error. List of files with errors in broken_files file.')
...
def indices_of_introns_and_exons_fun(seq1_DT, seq2_DT, seq1, seq2, count_deleted_gaps_left):
